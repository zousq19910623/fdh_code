...
(function( $ ) {
	...
	function createBox( $fileInput, file, webUploader ) {
		...
		/*	var div = '<div class="diyButton"> \
					...
					var div = '<div class="diyButton" > \
						<a class="diyStart" style="display:none;" href="javascript:void(0)">开始上传</a> \
					</div>';
					
				/*var div = '<div style="width:170px;height:150px;background:#red;"></div>';
					*/
					
					
			$parentFileBox.append( div );
			 $startButton = $parentFileBox.find('.diyStart');
			...
			var uploadStart = function (){
			  ...
			  $(".diyButton").on("touchend",function(){
		   //alert(1)
		  //绑定开始上传按钮;
	    ...
	    var li2 = '<li  style="width:170px;height:150px;background:#red;"><div id="test"></div></li>';
		
		   // alert($(".fileBoxUl li").length)
		     index = $(".fileBoxUl li").length;
		   AddPicture();
		...
		$('.fileBoxUl>li').css("height",$height);    
   ...
   function AddPicture(){
	    ...
	    //alert(width)
	    var  margin_left0 = width * 0.02;
	    var  left_width = width * 0.33;
	    var  margin_left1 = margin_left0 + left_width; 
	    var  margin_left2 = margin_left0*0.1 + left_width*2; 
	    var  margin_left3 = margin_left0*0.1 + left_width*3; 
	    var  height =width *0.31;
	    var  margin_top = width *0.325;
	    
		if(index==-1){
			   $(".webuploader-pick").css({"left":0,"top":0,"z-index":"1000"});
			   $(".webuploader-pick").next().css({"left":margin_left0,"top":0,"z-index":"1000"});
			
			}	 
				 		
		else if(index==0){
			    
				$(".webuploader-pick").css({"left":margin_left1,"top":"0px","z-index":"1000"});
				$(".webuploader-pick").next().css({"left":margin_left1,"top":"0px","z-index":"1000"});
	
			}
			
			
		else if(index==1){
			   	$(".webuploader-pick").css({"left":margin_left2,"top":"0px","z-index":"1000"});
			    $(".webuploader-pick").next().css({"left":margin_left2,"top":"0px","z-index":"1000"});
			 
			}
	
	    else if(index==2){
			   
			   $(".webuploader-pick").css({"left":margin_left0,"top":margin_top,"z-index":"1000"});
			   $(".webuploader-pick").next().css({"left":margin_left0,"top":margin_top,"z-index":"1000"});
			
	    }
		
		 else if(index==3){
		 	   $(".webuploader-pick").css({"left":margin_left1,"top":margin_top,"z-index":"1000"});
			   $(".webuploader-pick").next().css({"left":margin_left1,"top":margin_top,"z-index":"1000"});

			}
			
		  else if(index==4){
		  	
		  	   $(".webuploader-pick").css({"left":margin_left2,"top":margin_top,"z-index":"1000"});
			   $(".webuploader-pick").next().css({"left":margin_left2,"top":margin_top,"z-index":"1000"});
			   
			}
			
		  else if(index==5){
		  	   
		  	   $(".webuploader-pick").css({"left":margin_left0,"top":margin_top*2,"z-index":"1000"});
			   $(".webuploader-pick").next().css({"left":margin_left0,"top":margin_top*2,"z-index":"1000"});
		
			}
		  else if(index==6){
		  	  $(".webuploader-pick").css({"left":margin_left1,"top":margin_top*2,"z-index":"1000"});
			  $(".webuploader-pick").next().css({"left":margin_left1,"top":margin_top*2,"z-index":"1000"});
		
			}	
		  else if(index==7){
		  	  $(".webuploader-pick").css({"display":"block", "left":margin_left2,"top":margin_top*2,"z-index":"1000"});
			  $(".webuploader-pick").next().css({"display":"block", "left":margin_left2,"top":margin_top*2,"z-index":"1000"});
		
			}	
			
		  else if(index==8){
		  	   
		  	   $(".webuploader-pick").css({"display":"none", "left":margin_left3,"top":margin_top*2,"z-index":"1000"});
			   $(".webuploader-pick").next().css({"display":"none","left":margin_left3,"top":margin_top*2,"z-index":"1000"});
